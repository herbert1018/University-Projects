...
class AlexNet(nn.Module):
    def __init__(self, num_classes=5, input_size=(256, 256)):
        super(AlexNet, self).__init__()
        
        # 簡化特徵提取層
        self.features = nn.Sequential(
            # 第一層
            nn.Conv2d(3, 64, kernel_size=11, stride=4, padding=2),  # 增加通道數
            nn.BatchNorm2d(64),
        ...
        with torch.no_grad():
            ...
            flattened_size = feat.shape[1] * feat.shape[2] * feat.shape[3]
...
def train_model(model, train_loader, criterion, optimizer, num_epochs, update_training_progress, val_loader=None, patience=15):
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        if val_loader is not None:
            ...
            val_f1 = f1_score_metric(all_preds, all_labels, 5)
